...
from ansible_collections.ansible.aireos.plugins.modules import aireos_command
...
class TestCiscoWlcCommandModule(TestCiscoWlcModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.aireos.plugins.modules.aireos_command.run_commands')
