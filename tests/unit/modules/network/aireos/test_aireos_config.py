...
from ansible_collections.ansible.aireos.tests.unit.compat.mock import patch
from ansible_collections.ansible.aireos.plugins.modules import aireos_config
from ansible_collections.ansible.aireos.tests.unit.modules.utils import set_module_args
...
class TestCiscoWlcConfigModule(TestCiscoWlcModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.aireos.plugins.modules.aireos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.aireos.plugins.modules.aireos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.aireos.plugins.modules.aireos_config.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_save_config = patch('ansible_collections.ansible.aireos.plugins.modules.aireos_config.save_config')
